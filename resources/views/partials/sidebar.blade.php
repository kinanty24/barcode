...
<aside class="sidebar">
    ...
    <ul class="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link @if ($title == "Dashboard") @else collapsed @endif" href="{{ route("home") }}">
        ...
        @if (auth()->user()->role_id == 1)
            ...
            <li class="nav-item">
                <a class="nav-link @if ($title == "Data Matkul") @else collapsed @endif"
            ...
            <li class="nav-item">
                <a class="nav-link @if ($title == "Data Mahasiswa") @else collapsed @endif"
            ...
            <li class="nav-item">
                <a class="nav-link @if ($title == "Data Barcode") @else collapsed @endif"
                    href="{{ route("barcode.index") }}">
                    <i class="bi bi-card-list"></i>
                    <span>Data Barcode Absensi</span>
                </a>
